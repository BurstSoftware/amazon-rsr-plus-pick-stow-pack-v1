...
if page == "🏠 Home & Summary":
    ...
    **Note**: 
    ...
    # Combine Pick + Stow opportunities for each associate
    ...
    display_df = display_df.rename(columns={"index": "Associate"})
    st.dataframe(
    ...
    # Bar chart of spending per associate
    st.subheader("Spending Distribution by Associate")
    chart_data = display_df.head(10)  # Top 10 for better visibility
